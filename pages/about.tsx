export default function AboutPage() {
  return (
    <div className="bg-white text-gray-900 px-6 py-16">
      {/* ABOUT US */}
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-gray-700 font-semibold">Business, Organisational Structure</p>
          ...
          <div>
            ...
            <p className="text-gray-700 font-semibold">Business Procedure</p>
            <p className="mt-2 text-gray-600">
          ...
          <div>
            ...
            <p className="text-gray-700 font-semibold">The Tech and AI Wiz</p>
            <p className="mt-2 text-gray-600">
